...
namespace Discount.Grpc.Extensions
{
    public static class HostExtensions
    {
        ...
        public static WebApplication ApplyMigrations<TContext>(this WebApplication app, int ? retryForAvailability=0)
        ...
        private static void ExecuteMigrations(IConfiguration configuration)
        {
            ...
            command.CommandText = "INSERT INTO Coupon(ProductName, Description, Amount) VALUES('IPhone X', 'IPhone Discount7', 170);";
            command.ExecuteNonQuery();

            command.CommandText = "INSERT INTO Coupon(ProductName, Description, Amount) VALUES('Samsung 10', 'Samsung Discount7', 170);";
            command.ExecuteNonQuery();
        }
    }
}
